...
2. **获取缓存**：执行 `python3 scripts/cache_docs.py --skill frontend-beetl --permalink <permalink>` 脚本，缓存目录为 `references/.cache/frontend-beetl/`，不存在时自动回退到 `~/.cache/jeesite/frontend-beetl/`
